...
export default async function handler(req, res) {
  ...
  try {
    const query = `
      SELECT 
        'Material Informático' as categoria, p.id_activo, p.codigo_patrimonial as computador, p.numero_serie, p.marca_modelo, p.estado_operativo, p.procesador, p.ram,
        d.detalles_json->>'disco_duro' as disco_duro, d.detalles_json->>'usuario_pc' as usuario_pc,
        e.dni, e.nombre_completo as nombre_empleado, e.cargo as oficio_cargo, e.area, a.id_acta, 'material_informatico' as tipo_vista
      FROM pcs p
      ...
      SELECT 
        'Teléfono Móvil', t.id_activo, t.codigo_patrimonial, t.numero_serie, t.marca_modelo, t.estado_operativo, NULL, NULL, NULL, NULL,
      ...
      SELECT 
        'Periférico', pr.id_activo, pr.codigo_patrimonial, pr.numero_serie, pr.marca_modelo, pr.estado_operativo, NULL, NULL, NULL, NULL,
      ...
      SELECT 
        'Línea Móvil', l.id_linea, l.iccid_sim, l.numero_telefono, l.operador, l.estado_linea, NULL, NULL, NULL, NULL,
